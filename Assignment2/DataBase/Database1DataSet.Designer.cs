...
namespace Assignment2.DataBase {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class BookDataTable : global::System.Data.TypedTableBase<BookRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public BookRow AddBookRow(int book_id, string title, string author, string genre, double price) {
...
namespace Assignment2.DataBase.Database1DataSetTableAdapters {
    ...
    public partial class BookTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Book] WHERE (([book_id] = @Original_book_id) AND ([title] = @O" +
                "riginal_title) AND ([author] = @Original_author) AND ([genre] = @Original_genre)" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Book] ([book_id], [title], [author], [genre], [price]) VALUES " +
                "(@book_id, @title, @author, @genre, @price);\r\nSELECT book_id, title, author, gen" +
                "re, price FROM Book WHERE (book_id = @book_id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Book] SET [book_id] = @book_id, [title] = @title, [author] = @author, [genre] = @genre, [price] = @price WHERE (([book_id] = @Original_book_id) AND ([title] = @Original_title) AND ([author] = @Original_author) AND ([genre] = @Original_genre) AND ([price] = @Original_price));
SELECT book_id, title, author, genre, price FROM Book WHERE (book_id = @book_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Assignment2.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT book_id, title, author, genre, price FROM dbo.Book";
        ...
        public virtual int Delete(int Original_book_id, string Original_title, string Original_author, string Original_genre, double Original_price) {
        ...
        public virtual int Insert(int book_id, string title, string author, string genre, double price) {
        ...
        public virtual int Update(int book_id, string title, string author, string genre, double price, int Original_book_id, string Original_title, string Original_author, string Original_genre, double Original_price) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string title, string author, string genre, double price, int Original_book_id, string Original_title, string Original_author, string Original_genre, double Original_price) {
            return this.Update(Original_book_id, title, author, genre, price, Original_book_id, Original_title, Original_author, Original_genre, Original_price);
        }
    }
